  ...
  return (
    <div className="flex flex-col p-4 gap-1 bg-white rounded-lg border-2 border-primary-light shadow-md w-full max-h-fit hover:shadow-lg hover:scale-[1.01] transition">
      <div className="flex w-full justify-between items-center">
        <h1 className="text-md font-semibold mb-2 text-text-primary">{name}</h1>
      ...
      <div>
        <p className="text-text-secondary text-sm line-clamp-3">
          ...
          adipisicing elit. Labore qui obcaecati magnam unde exercitationema
          wdawawawdawaw dawdawwd
        </p>
      </div>
      ...
      <div className="flex justify-between items-end">
        <div className="mt-2 flex flex-col gap-1">
          <div className=" flex items-center gap-1">
            ...
            <p className="text-text-tertiary text-[0.7rem] font-medium">
              Av. Principal 2
            </p>
          </div>
          <div className=" flex items-center gap-1">
          ...
          <div className=" flex item-center gap-1">
            <GlobeIcon color="#6a737d" size={16} />
            <p className="text-text-tertiary text-[0.7rem] font-  medium">
              www.glowhub.com.br
            </p>
          </div>
